...
│                                                                     │
│  /boot/loader/entries:         Synced via /usr/local/bin/esp-sync.sh │
...
┌─────────────────────────────────────────────────────────────────────┐
│                     HDD RAID (BTRFS) — 24TB×2                       │
│                     sda + sdd (whole-disk)                           │
│            UUID: 8b66e847-4273-4e2a-ad53-b312b3b3ee6d               │
│                                                                     │
│  ⚠ RAID-0→RAID-1 BALANCE IN PROGRESS (see Section 7)               │
...
> ### ⚠️ CRITICAL WARNING: RAID-0 DATA LOSS RISK ⚠️
>
